...
public class ItemSetup extends TFCItems {
	...
	{
		Global.BISMUTH = new Metal("Bismuth", TFCItems.bismuthUnshaped, TFCItems.bismuthIngot).setColor(4228512);
		Global.BISMUTHBRONZE = new Metal("Bismuth Bronze", TFCItems.bismuthBronzeUnshaped, TFCItems.bismuthBronzeIngot).setColor(4888919);
		Global.BLACKBRONZE = new Metal("Black Bronze", TFCItems.blackBronzeUnshaped, TFCItems.blackBronzeIngot).setColor(4733000);
		Global.BLACKSTEEL = new Metal("Black Steel", TFCItems.blackSteelUnshaped, TFCItems.blackSteelIngot).setColor(2039329);
		Global.BLUESTEEL = new Metal("Blue Steel", TFCItems.blueSteelUnshaped, TFCItems.blueSteelIngot).setColor(3827111);
		Global.BRASS = new Metal("Brass", TFCItems.brassUnshaped, TFCItems.brassIngot).setColor(10785847);
		Global.BRONZE = new Metal("Bronze", TFCItems.bronzeUnshaped, TFCItems.bronzeIngot).setColor(8941378);
		Global.COPPER = new Metal("Copper", TFCItems.copperUnshaped, TFCItems.copperIngot).setColor(13388592);
		Global.GOLD = new Metal("Gold", TFCItems.goldUnshaped, TFCItems.goldIngot).setColor(16761380);
		Global.WROUGHTIRON = new Metal("Wrought Iron", TFCItems.wroughtIronUnshaped, TFCItems.wroughtIronIngot).setColor(11447212);
		Global.LEAD = new Metal("Lead", TFCItems.leadUnshaped, TFCItems.leadIngot).setColor(5330521);
		Global.NICKEL = new Metal("Nickel", TFCItems.nickelUnshaped, TFCItems.nickelIngot).setColor(6316364);
		Global.PIGIRON = new Metal("Pig Iron", TFCItems.pigIronUnshaped, TFCItems.pigIronIngot).setColor(8414574);
		Global.PLATINUM = new Metal("Platinum", TFCItems.platinumUnshaped, TFCItems.platinumIngot).setColor(11716830);
		Global.REDSTEEL = new Metal("Red Steel", TFCItems.redSteelUnshaped, TFCItems.redSteelIngot).setColor(8850957);
		Global.ROSEGOLD = new Metal("Rose Gold", TFCItems.roseGoldUnshaped, TFCItems.roseGoldIngot).setColor(16745808);
		Global.SILVER = new Metal("Silver", TFCItems.silverUnshaped, TFCItems.silverIngot).setColor(10855586);
		Global.STEEL = new Metal("Steel", TFCItems.steelUnshaped, TFCItems.steelIngot).setColor(7039853);
		Global.STERLINGSILVER = new Metal("Sterling Silver", TFCItems.sterlingSilverUnshaped, TFCItems.sterlingSilverIngot).setColor(14663068);
		Global.TIN = new Metal("Tin", TFCItems.tinUnshaped, TFCItems.tinIngot).setColor(11189711);
		Global.ZINC = new Metal("Zinc", TFCItems.zincUnshaped, TFCItems.zincIngot).setColor(15197164);
		Global.WEAKSTEEL = new Metal("Weak Steel", TFCItems.weakSteelUnshaped, TFCItems.weakSteelIngot).setColor(10329503);
		Global.HCSTEEL = new Metal("HC Steel", TFCItems.highCarbonSteelUnshaped, TFCItems.highCarbonSteelIngot).setColor(5723993);
		Global.HCBLACKSTEEL = new Metal("HC Black Steel", TFCItems.highCarbonBlackSteelUnshaped, TFCItems.highCarbonBlackSteelIngot).setColor(1447191);
		Global.WEAKREDSTEEL = new Metal("Weak Red Steel", TFCItems.weakRedSteelUnshaped, TFCItems.weakRedSteelIngot).setColor(12140607);
		Global.HCREDSTEEL = new Metal("HC Red Steel", TFCItems.highCarbonRedSteelUnshaped, TFCItems.highCarbonRedSteelIngot).setColor(6684672);
		Global.WEAKBLUESTEEL = new Metal("Weak Blue Steel", TFCItems.weakBlueSteelUnshaped, TFCItems.weakBlueSteelIngot).setColor(7837639);
		Global.HCBLUESTEEL = new Metal("HC Blue Steel", TFCItems.highCarbonBlueSteelUnshaped, TFCItems.highCarbonBlueSteelIngot).setColor(340082);
		Global.UNKNOWN = new Metal("Unknown", TFCItems.unknownUnshaped, TFCItems.unknownIngot, false).setColor(5330521);
